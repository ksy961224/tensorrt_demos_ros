...
from yolonano_msg.msg import yolonano 
import numpy as np
# ----------------------------
...
def loop_and_detect(cam, trt_yolo, conf_th, vis):
    ...
    mtx=np.array([389.561779749311, 0, 311.1969258590246, 0, 519.5439579814732, 227.2177809575603, 0, 0, 1]).reshape([3,3])
    dist=np.array([-0.3095348756010097, 0.08261469271300352, 9.236621974685883e-05, -0.000425899841382961, 0]).reshape([1,5])
    newcameramtx=np.array([291.1513671875, 0, 305.4419828384416, 0, 0, 481.8479309082031, 225.1265387215271, 0, 0, 0, 1, 0]).reshape([3,4])
